...
const mockLogs: AuditLogEntry[] = [
    { id: '1', user: 'Alex Rivera', action: 'Stage Changed', details: 'Moved "Elite Cloud" to Negotiation', timestamp: new Date() },
    { id: '2', user: 'Alex Rivera', action: 'Lead Created', details: 'Added "Peter Gregory" from LinkedIn', timestamp: new Date(Date.now() - 3600000) },
    { id: '3', user: 'Michael Chen', action: 'Settings Updated', details: 'Changed Global Currency to JPY', timestamp: new Date(Date.now() - 7200000) },
];
